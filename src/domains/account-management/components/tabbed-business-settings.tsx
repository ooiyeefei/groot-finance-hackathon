...
import { Building2, DollarSign, Users, Key, Loader2, Calendar, Sparkles, User, Plug, Clock, Shield, Gift, FileText } from 'lucide-react'
...
const TabbedBusinessSettings = memo(() => {
  ...
  const validTabs = ['business-profile', 'category-management', 'leave-management', 'timesheet', 'team-management', 'api-keys', 'billing', 'integrations', 'einvoice', 'referral', 'privacy', 'profile'] as const
