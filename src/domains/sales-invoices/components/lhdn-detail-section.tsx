...
import { AlertTriangle, Copy, CheckCircle2, FileText, ChevronDown, ChevronRight } from 'lucide-react'
      ...
      <Card className="bg-card border-border">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <FeatureInterestButton featureName="lhdn-einvoice-issuing" />
          </div>
        </CardHeader>
        {isExpanded && (
          <CardContent className="space-y-3">
            <div className="relative">
              {/* Blur overlay to indicate early access */}
              <div className="absolute inset-0 backdrop-blur-sm bg-background/50 z-10 rounded-md flex items-center justify-center">
                <p className="text-sm text-muted-foreground font-medium">
                  Available with LHDN digital certificate
                </p>
              </div>
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <FeatureInterestButton featureName="lhdn-einvoice-status-polling" />
          </div>
        </div>
      </CardHeader>
      {isExpanded && (
