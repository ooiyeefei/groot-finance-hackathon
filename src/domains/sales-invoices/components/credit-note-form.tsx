...
import { useCreditNoteMutations } from '@/domains/sales-invoices/hooks/use-sales-invoices'
    ...
    <Card className="bg-card border-border">
      ...
      <CardContent className="space-y-4">
        <p className="text-xs text-muted-foreground">
          Max creditable: {formatCurrency(maxAmount, currency)}
        </p>
        ...
        <div className="space-y-1.5">
          ...
          <Input
            placeholder="e.g., Goods returned, pricing adjustment..."
            value={reason}
