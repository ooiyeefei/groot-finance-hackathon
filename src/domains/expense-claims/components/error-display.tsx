 ...
 *
 * Displays user-friendly error messages with actionable guidance for expense claim processing failures
 * Integrates with the error message mapper for consistent error handling UX
 */

'use client'

import { AlertCircle, RefreshCw, Phone, Clock, CheckCircle } from 'lucide-react'
import { formatErrorForUI, getRetryRecommendation, type ErrorContext } from '../lib/error-message-mapper'
...
/**
 * Compact error display for inline use (e.g., in forms or cards)
 */
...
/**
 * Error toast notification component for temporary error display
 */
...
/**
 * Processing status indicator with error state support
 */
