...
const foundingBenefits = [
  'Free Groot Reservation for your own business*',
  'Founding Badge in Partner Directory',
  'Priority roadmap input',
  'RM 1,000 Milestone Bonus**',
  'Double commission (RM 600) on first 50 annual subscriptions***',
  'Co-marketing as a featured AI-first partner',
    ...
    <div className="min-h-screen bg-[#F0F2F5] print:bg-white">
      ...
      <div className="no-print sticky top-0 z-50 flex items-center justify-center gap-3 bg-gradient-to-r from-[#1E293B] to-[#111827] px-4 py-3 text-white">
        ...
        <p className="text-[15px] font-medium">
          ...
          2x commission — RM 600 (Starter) to RM 1,600 (Pro) on first 50 annual deals{' '}
        ...
        >
          <Sparkles className="mr-1 inline h-3.5 w-3.5" /> Apply Now
        </button>
      </div>
          ...
          <section className="print-card border-t border-[#E5E7EB] px-5 py-8 sm:px-8 sm:py-10 md:px-12">
            <div className="rounded-xl border-2 border-[#4285F4]/30 bg-gradient-to-br from-[#4285F4]/5 to-[#4285F4]/10 p-6 text-center">
              ...
              <p className="mt-2 text-base text-[#6B7280]">
                <strong>RM 600 (Starter Annual)</strong> to <strong>RM 1,600 (Pro Annual)</strong> per deal — limited to first 50 annual subscriptions across all resellers.
              </p>
            ...
            <div className="founding-card overflow-hidden rounded-2xl bg-gradient-to-br from-[#1E293B] to-[#111827] p-8 md:p-10">
              ...
              <div className="mt-6 rounded-lg bg-white/5 px-4 py-3">
                <p className="text-[13px] leading-relaxed text-[#94A3B8]">
                  ...
                  **Paid at 10th active customer.<br />
                  ***Starter plan rate shown. Pro plan: RM 1,600 per deal.
                </p>
              </div>
            </div>
          </section>
