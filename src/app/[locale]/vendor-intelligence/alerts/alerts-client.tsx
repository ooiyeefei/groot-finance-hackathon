...
/**
 * T025: Alerts list client component.
 * Renders anomaly alerts with filters and real-time updates.
 */
...
export default function AlertsClient() {
  const { businessId: rawBusinessId, isLoading: isBusinessLoading } = useActiveBusiness();
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <Select
          ...
          onValueChange={(v) =>
            setStatus(v === "all" ? undefined : (v as "active" | "dismissed"))
          }
        >
        ...
        <Select
          ...
          onValueChange={(v) =>
            setSeverityLevel(
              v === "all" ? undefined : (v as "standard" | "high-impact")
            )
          }
        >
      ...
      {alerts.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12 text-muted-foreground">
          ...
          <p className="text-xs mt-1">
            Alerts will appear here when price anomalies are detected
          </p>
        </div>
      ) : (
