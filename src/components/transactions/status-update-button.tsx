...
type TransactionStatus = 'pending' | 'awaiting_payment' | 'paid' | 'overdue' | 'cancelled' | 'disputed'

interface StatusUpdateButtonProps {
  currentStatus: TransactionStatus
  transactionId: string
  onStatusUpdate: (newStatus: TransactionStatus) => Promise<void>
  disabled?: boolean
}
...
export default function StatusUpdateButton({
  ...
  const [selectedStatus, setSelectedStatus] = useState<TransactionStatus>(currentStatus)
