...
import { ExpenseFormData, ReceiptInfo, AISuggestion } from '@/hooks/use-expense-form'
      ...
      {receiptInfo.hasReceipt ? (
        <div className="flex items-center justify-between h-full">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white font-medium">{receiptInfo.filename}</p>
        ...
        <div className="border-2 border-dashed border-gray-500 rounded-lg p-6 h-full flex items-center justify-center">
          <div className="text-center">
            ...
            <Label htmlFor="receipt-upload" className="cursor-pointer">
              <Button type="button" className="bg-blue-600 hover:bg-blue-700 text-white" size="sm">
                Choose File
              </Button>
            </Label>
          </div>
