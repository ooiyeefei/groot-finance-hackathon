...
export const reportEinvoiceFormFillResult = mutation({
  args: {
    ...
    confidenceGateDecision: v.optional(v.string()),
  ...
  handler: async (ctx, args) => {
    ...
    if (requestLog) {
      ...
      // DSPy self-learning fields
      if (args.reconDescription) logUpdate.reconDescription = args.reconDescription;
      if (args.generatedHint) logUpdate.generatedHint = args.generatedHint;
      ...
      if (args.perFieldResults) logUpdate.perFieldResults = args.perFieldResults;
      if (args.buyerProfileMatchResult) logUpdate.buyerProfileMatchResult = args.buyerProfileMatchResult;
      if (args.dspyModuleVersion) logUpdate.dspyModuleVersion = args.dspyModuleVersion;
      // Set hint effectiveness to "pending" when a hint is generated
      if (args.generatedHint) logUpdate.hintEffectivenessOutcome = "pending";
