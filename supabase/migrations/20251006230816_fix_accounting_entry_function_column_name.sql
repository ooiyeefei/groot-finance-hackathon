-- Fix create_accounting_entry_from_approved_claim function to use employee_id instead of user_id
-- The expense_claims table has employee_id, not user_id
...
BEGIN
  ...
  VALUES (
    v_claim.employee_id,  -- FIXED: Use employee_id instead of user_id
    v_business_id,
...
FIXED: Now uses employee_id instead of user_id to match expense_claims schema.
