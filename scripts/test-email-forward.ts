...
async function simulateEmailForward(config: TestConfig) {
  ...
  try {
    ...
    if (actionResult.status === "error") {
      ...
      console.log("   To test end-to-end, send real email to prefix@inbox.hellogroot.com");
      return;
    }
...
console.log("For full end-to-end testing, send a real email to prefix@inbox.hellogroot.com\n");
